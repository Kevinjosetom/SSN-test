...
//		test.info("click on the play now button");
		click1(buttonWithtext("Play now"), "the play now button");
		Thread.sleep(3000);
...
//		logger.info("click on the next button");
		click1("//*[text()='Apply Now']/following::mat-radio-button", "the first option");
		Thread.sleep(5000);

		click1("//span[contains(text(),' Next ')]", "the next button");
		Thread.sleep(5000);
	//	click1("//*[text()='Apply Now']/following::mat-radio-button", "cick on the first option");
		Thread.sleep(5000);
		click1("//*[text()='Apply Now']/following::mat-checkbox", "the Second option");
		Thread.sleep(5000);
		click1("//span[contains(text(),' Next ')]", "the next button");
		Thread.sleep(5000);
		...
		//	waitForElementPresent("//*[text()='Apply Now']/following::mat-radio-button");
			...
			Thread.sleep(1000);
			click1("//*[text()='Apply Now']/following::mat-radio-button", "the  option");
		...
		//	Thread.sleep(2000);
			...
			//click(id("mat-radio-5"), "select the first option");
			Thread.sleep(1000);
			click1("//*[starts-with(@id,'mat-radio-')]", "the option on level Questions");

			//click on the next button
			Thread.sleep(1000);
			test.info("click on the next button");
			click1("//*[contains(text(),'Next')]", "the next button on level Questions");
			Thread.sleep(2000);
			
	}
			click1("//*[text()='Continue']","the contnue Button");
			Thread.sleep(3000);
		    click1("//*[text()='Skip']", "the skip button");
			
		    Thread.sleep(1000);
		
		   click1("//*[text()=' Done ']", "the done button");
		   Thread.sleep(6000);

		
	}
	
	public void  mandatoryQuestion2() throws IOException, InterruptedException {
...
//		logger.info("click on the next button");
	...
	//	click1("//*[text()='Apply Now']/following::mat-radio-button", "cick on the first option");
		...
		//	Thread.sleep(2000);
			...
			waitTime();
			waitTime();
		    click1("//*[contains(text(),'Claim now')]", "the skip button");
...
//		   click1("//*[text()=' Done ']", "the done button");
	...
	public void searchCompetitionAndClick() throws IOException, InterruptedException {
		...
		String competationName = data.competationName;
//		test.info("click on the competitions hyperlink");
		clickHyperlink("Competitions", " the competitions hyperlink");

//		test.info("type on the search box for competitions");
		waitForElementPresent("//input[@placeholder='Search']");
		type1("//input[@placeholder='Search']",competationName, "Enter the Competition Name");
		Thread.sleep(3000);
		waitForElementPresent("//div/a[@title='competitionName']".replaceAll("competitionName", competationName));
		scrollToView("//*[@id='competition-sticky']", " categories");
		Thread.sleep(2000);
		scrollToView("/html/body/app-root/app-public/app-competitions/section/div/div/div[1]", "competition");
//		test.info("click on the particualr competitions");
		Thread.sleep(2000);
		click1("//*[text()='XBOX']".replaceAll("XBOX", competationName), " the particular competitions");
	}
