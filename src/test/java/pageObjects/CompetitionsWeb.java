...
public class CompetitionsWeb extends ReusableMethods {
	...
	@FindBy(xpath="//*[text()=' Test@2691 (1 segments) ']")
	...
	public CompetitionsWeb Competition_Create() throws Exception {
		//Test data;
			...
			waitForElementVisibility(save_competition, "save_New_Catrgorie");
			click(save_competition, "save");
			waitTime();
	...
	click1("(//*[contains(text(),'Select Questionnaire')])[2]", "Open Questionnaire dropdown");
	waitTime();
    mouseHoverAndClick(select_questionnaries1, " select questionnaires");
    waitTime();
    click(save, "save the levels");
    waitTime();
