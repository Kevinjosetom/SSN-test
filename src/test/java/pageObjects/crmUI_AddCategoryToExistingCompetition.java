...
public class crmUI_AddCategoryToExistingCompetition extends ReusableMethods {
	...
	public crmUI_AddCategoryToExistingCompetition stagingUrl_launch() throws Exception {
...
//		Userlogin1();
	...
	public void Userlogin1() throws Exception{
		...
		text(email_id, "7893932959@mailinator.com", "enter email");
		waitTime();
		text(password, "tester123", "enter pwd");
